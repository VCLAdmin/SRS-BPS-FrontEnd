...
export class OuterTableComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    /**
     * This observable handles the display of the table for outer frmae or bottom outer frame.
  ...
  /**
   * When the user clicks on the confirm button or double clicks on a row, the information of the row selected is sent to the unified model service to update the outer frame or bottom outer frame property.
