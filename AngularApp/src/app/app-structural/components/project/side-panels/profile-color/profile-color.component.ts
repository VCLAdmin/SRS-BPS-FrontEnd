...
export class ProfileColorComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  /**
   * When the user clicks on the confirm button or double clicks on a row, the information of the row selected is sent to the unified model service to update the profile color property.
